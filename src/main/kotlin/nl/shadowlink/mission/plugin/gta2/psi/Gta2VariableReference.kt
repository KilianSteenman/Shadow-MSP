...
internal class Gta2VariableReference(
    element: MissionVariableReference,
    textRange: TextRange
) : PsiReferenceBase<MissionVariableReference>(element, textRange), PsiPolyVariantReference {
