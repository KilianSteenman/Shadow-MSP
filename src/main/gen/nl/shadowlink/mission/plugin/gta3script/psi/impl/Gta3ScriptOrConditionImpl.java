...
public class Gta3ScriptOrConditionImpl extends ASTWrapperPsiElement implements Gta3ScriptOrCondition {

  public Gta3ScriptOrConditionImpl(@NotNull ASTNode node) {
    super(node);
  }
