...
public class Gta3ScriptLaunchMissionCallImpl extends ASTWrapperPsiElement implements Gta3ScriptLaunchMissionCall {

  public Gta3ScriptLaunchMissionCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Gta3ScriptVisitor visitor) {
    visitor.visitLaunchMissionCall(this);
  }
