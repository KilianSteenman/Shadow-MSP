...
public class Gta3ScriptDefinitionBlockImpl extends ASTWrapperPsiElement implements Gta3ScriptDefinitionBlock {

  public Gta3ScriptDefinitionBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
