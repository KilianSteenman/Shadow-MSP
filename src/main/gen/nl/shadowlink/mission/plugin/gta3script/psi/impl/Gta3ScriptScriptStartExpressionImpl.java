...
public class Gta3ScriptScriptStartExpressionImpl extends ASTWrapperPsiElement implements Gta3ScriptScriptStartExpression {

  public Gta3ScriptScriptStartExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Gta3ScriptVisitor visitor) {
    visitor.visitScriptStartExpression(this);
  }
