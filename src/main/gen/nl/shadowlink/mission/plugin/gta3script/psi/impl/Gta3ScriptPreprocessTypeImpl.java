...
public class Gta3ScriptPreprocessTypeImpl extends ASTWrapperPsiElement implements Gta3ScriptPreprocessType {

  public Gta3ScriptPreprocessTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
