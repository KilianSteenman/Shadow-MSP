...
public class Gta3ScriptPreprocessBlockImpl extends ASTWrapperPsiElement implements Gta3ScriptPreprocessBlock {

  public Gta3ScriptPreprocessBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public Gta3ScriptPreprocessType getPreprocessType() {
    return findNotNullChildByClass(Gta3ScriptPreprocessType.class);
  }
