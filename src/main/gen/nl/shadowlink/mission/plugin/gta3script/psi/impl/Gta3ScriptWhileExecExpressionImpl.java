...
public class Gta3ScriptWhileExecExpressionImpl extends ASTWrapperPsiElement implements Gta3ScriptWhileExecExpression {

  public Gta3ScriptWhileExecExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public Gta3ScriptConditionalStatement getConditionalStatement() {
    return findNotNullChildByClass(Gta3ScriptConditionalStatement.class);
  }
