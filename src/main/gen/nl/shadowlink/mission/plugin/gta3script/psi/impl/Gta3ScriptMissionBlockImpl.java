...
public class Gta3ScriptMissionBlockImpl extends ASTWrapperPsiElement implements Gta3ScriptMissionBlock {

  public Gta3ScriptMissionBlockImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull Gta3ScriptVisitor visitor) {
    visitor.visitMissionBlock(this);
  }
