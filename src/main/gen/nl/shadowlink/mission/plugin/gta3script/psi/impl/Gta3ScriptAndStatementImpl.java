...
public class Gta3ScriptAndStatementImpl extends ASTWrapperPsiElement implements Gta3ScriptAndStatement {

  public Gta3ScriptAndStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
