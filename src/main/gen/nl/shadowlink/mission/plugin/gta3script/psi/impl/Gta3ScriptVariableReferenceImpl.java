...
public class Gta3ScriptVariableReferenceImpl extends ASTWrapperPsiElement implements Gta3ScriptVariableReference {

  public Gta3ScriptVariableReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }
