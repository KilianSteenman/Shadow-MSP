...
public class Gta3ScriptComparisonOperatorImpl extends ASTWrapperPsiElement implements Gta3ScriptComparisonOperator {

  public Gta3ScriptComparisonOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
