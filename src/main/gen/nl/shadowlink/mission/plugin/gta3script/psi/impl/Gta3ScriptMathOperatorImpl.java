...
public class Gta3ScriptMathOperatorImpl extends ASTWrapperPsiElement implements Gta3ScriptMathOperator {

  public Gta3ScriptMathOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }
