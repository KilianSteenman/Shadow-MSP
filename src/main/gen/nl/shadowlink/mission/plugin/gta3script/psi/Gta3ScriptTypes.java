...
public interface Gta3ScriptTypes {
  ...
  IElementType LEVEL_BLOCK = new Gta3ScriptElementType("LEVEL_BLOCK");
  IElementType LEVEL_BODY = new Gta3ScriptElementType("LEVEL_BODY");
  ...
  IElementType WHILE_EXEC_EXPRESSION = new Gta3ScriptElementType("WHILE_EXEC_EXPRESSION");
  ...
  IElementType ARROW_DATA = new Gta3ScriptTokenType("ARROW_DATA");
  IElementType BONUS = new Gta3ScriptTokenType("BONUS");
  IElementType CAR_DATA = new Gta3ScriptTokenType("CAR_DATA");
  IElementType CHAR_DATA = new Gta3ScriptTokenType("CHAR_DATA");
  IElementType COMMENT = new Gta3ScriptTokenType("COMMENT");
  IElementType COMMENTBLOCK = new Gta3ScriptTokenType("COMMENTBLOCK");
  IElementType CONVEYOR = new Gta3ScriptTokenType("CONVEYOR");
  IElementType COUNTER = new Gta3ScriptTokenType("COUNTER");
  IElementType CRANE_DATA = new Gta3ScriptTokenType("CRANE_DATA");
  IElementType CRIMINAL_TYPE2 = new Gta3ScriptTokenType("CRIMINAL_TYPE2");
  IElementType CRUSHER = new Gta3ScriptTokenType("CRUSHER");
  IElementType DEF_PC = new Gta3ScriptTokenType("PC");
  IElementType DEF_PSX = new Gta3ScriptTokenType("PSX");
  IElementType DESTRUCTOR = new Gta3ScriptTokenType("DESTRUCTOR");
  ...
  IElementType FORWARD = new Gta3ScriptTokenType("FORWARD");
  IElementType GENERATOR = new Gta3ScriptTokenType("GENERATOR");
  ...
  IElementType LIGHT = new Gta3ScriptTokenType("LIGHT");
  IElementType MACHINE_GUN = new Gta3ScriptTokenType("MACHINE_GUN");
  IElementType MAP_ZONE = new Gta3ScriptTokenType("MAP_ZONE");
  ...
  IElementType OBJ_DATA = new Gta3ScriptTokenType("OBJ_DATA");
  IElementType OFF = new Gta3ScriptTokenType("OFF");
  IElementType ON = new Gta3ScriptTokenType("ON");
  IElementType ONSCREEN_COUNTER = new Gta3ScriptTokenType("ONSCREEN_COUNTER");
  ...
  IElementType PLAYER_PED = new Gta3ScriptTokenType("PLAYER_PED");
  ...
  IElementType SAVED_COUNTER = new Gta3ScriptTokenType("SAVED_COUNTER");
  IElementType SET = new Gta3ScriptTokenType("SET");
  IElementType SOUND = new Gta3ScriptTokenType("SOUND");
  IElementType SUBROUTINE = new Gta3ScriptTokenType("SUBROUTINE");
  IElementType THREAD_TRIGGER = new Gta3ScriptTokenType("THREAD_TRIGGER");
  IElementType TIMER_DATA = new Gta3ScriptTokenType("TIMER_DATA");
  ...
  class Factory {
    public static PsiElement createElement(ASTNode node) {
      ...
      if (type == AND_STATEMENT) {
        ...
        return new Gta3ScriptLevelBlockImpl(node);
      }
      else if (type == LEVEL_BODY) {
        return new Gta3ScriptLevelBodyImpl(node);
      }
        ...
        return new Gta3ScriptWhileExecExpressionImpl(node);
      }
