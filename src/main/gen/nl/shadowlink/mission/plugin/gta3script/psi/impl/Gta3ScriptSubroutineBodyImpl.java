...
public class Gta3ScriptSubroutineBodyImpl extends ASTWrapperPsiElement implements Gta3ScriptSubroutineBody {

  public Gta3ScriptSubroutineBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
